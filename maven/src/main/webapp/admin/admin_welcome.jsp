...
<div class="login layout f14"  style="width: 62%;text-align: center;margin: auto;">
	<div class="btn-ui-b mt10">
		<s:a action="categoryAction!index.action" namespace="/category">类别管理</s:a>
		<%--<a href="category/categoryAction!initAdd.action">添加类别</a>
	--%></div>
	<div class="btn-ui-b mt10">
		<a href="javascript:void(0);" onclick="">添加商家</a>
	</div>
	<div class="btn-ui-b mt10">
